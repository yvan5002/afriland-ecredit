...
app.use("/uploads", express.static(path.join(__dirname, "uploads"))); // servi pour verif interne uniquement

app.use(session({
  secret: "cle_secrete_afriland_ecredit_2026",
  resave: false,
  saveUninitialized: false,
  cookie: { maxAge: 1000 * 60 * 60 }, // 1h — suffisant pour remplir le formulaire multi-etapes
}));
